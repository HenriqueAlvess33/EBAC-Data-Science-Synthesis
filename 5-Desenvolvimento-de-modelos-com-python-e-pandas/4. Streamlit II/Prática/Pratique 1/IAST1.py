    ...
    with st.sidebar:
        with st.form(key="my_form"):
            ...
            jobs_all = st.checkbox(
                "Selecionar todas as profissões", value=True, key="job"
            )
            jobs_selected = st.multiselect(
                "Profissões",
                jobs_list,
                default=jobs_list if jobs_all else [],
                key="job_selected_filter",
            )
            ...
            marital_all = st.checkbox(
                "Selecionar todos os estados civis", value=True, key="marital"
            )
            marital_selected = st.multiselect(
                "Estado civil",
                marital_list,
                default=marital_list if marital_all else [],
                key="marital_selected_filter",
            )
            ...
            education_all = st.checkbox(
                "Selecionar todos os níveis de educação", value=True, key="education"
            )
            education_selected = st.multiselect(
                "Educação",
                education_list,
                default=education_list if education_all else [],
                key="education_selected_filter",
            )
            ...
            default_all = st.checkbox(
                "Selecionar todos os status de crédito", value=True, key="default"
            )
            default_selected = st.multiselect(
                "Status de crédito",
                default_list,
                default=default_list if default_all else [],
                key="default_selected_filter",
            )
            ...
            loan_all = st.checkbox(
                "Selecionar todos os status de crédito", value=True, key="loan"
            )
            loan_selected = st.multiselect(
                "Status de crédito",
                loan_list,
                default=loan_list if loan_all else [],
                key="loan_selected_filter",
            )
            ...
            contact_all = st.checkbox(
                "Selecionar todos os contatos", value=True, key="contact"
            )
            contact_selected = st.multiselect(
                "Contato",
                contact_list,
                default=contact_list if contact_all else [],
                key="contact_selected_filter",
            )
            ...
            month_all = st.checkbox(
                "Selecionar todos os meses de contato", value=True, key="month"
            )
            month_selected = st.multiselect(
                "Mês de contato",
                month_list,
                default=month_list if month_all else [],
                key="month_selected_filter",
            )
            ...
            days_of_week_all = st.checkbox(
                "Selecionar todos os dias de contato", value=True, key="day_of_week"
            )
            day_of_week_selected = st.multiselect(
                "Dia de contato",
                day_of_week_list,
                default=day_of_week_list if days_of_week_all else [],
                key="day_of_week_selected_filter",
            )
